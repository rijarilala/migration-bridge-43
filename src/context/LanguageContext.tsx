...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'immigration_services_description': 'Nous vous accompagnons à chaque étape de votre processus d\'immigration, de l\'évaluation initiale à l\'intégration réussie dans votre province canadienne.',
  ...
  en: {
    ...
    'immigration_services_description': 'We are with you every step of the way, from initial assessment to successful integration into your Canadian province.',
