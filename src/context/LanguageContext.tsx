...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'age_select': 'Âge (Sélectionner une tranche d\'âge)',
    'age_18_29': '18 - 29 ans',
    'age_30_39': '30 - 39 ans',
    'age_40_44': '40 - 44 ans',
    'age_45_plus': '45 ans et plus',
    'education_level': 'Niveau d\'études',
    'edu_none': 'Aucun diplôme',
    'edu_highschool': 'Diplôme d\'études secondaires',
    'edu_postsecondary': 'Diplôme postsecondaire (Bac+2)',
    'edu_bachelor': 'Licence (Bac+3)',
    'edu_master': 'Master ou Doctorat',
    ...
    'french': 'Français',
    'english': 'Anglais',
    'french_none': 'Aucune compétence',
    'french_intermediate': 'Niveau intermédiaire',
    'french_fluent': 'Courant',
    'english_none': 'Aucune compétence',
    'english_intermediate': 'Niveau intermédiaire',
    'english_fluent': 'Courant',
    'immigration_project': 'Votre projet d\'immigration',
    'canada_project': 'Votre projet au Canada',
    'project_study': 'Étudier',
    'project_work': 'Travailler',
    'project_settle': 'M\'établir de façon permanente',
    'project_family': 'Rejoindre un membre de ma famille',
    'profession_type': 'Type de profession (PSTQ)',
    'pstq_streams_description': 'Le nouveau Programme de sélection des travailleurs qualifiés (PSTQ) du Québec comprend 4 volets distincts :',
    'prof_highly_skilled': 'Profession hautement qualifiée (volet 1)',
    'prof_intermediate': 'Profession intermédiaire/manuelle (volet 2)',
    'prof_regulated': 'Profession réglementée requérant un permis au Québec (volet 3)',
    'prof_exceptional': 'Talent d\'exception (volet 4)',
    'prof_unknown': 'Je ne sais pas',
    'license_permit': 'Autorisation ou permis d\'exercice',
    'have_license': 'J\'ai ou je peux obtenir une autorisation d\'exercice au Québec',
    'no_license': 'Je n\'ai pas d\'autorisation d\'exercice au Québec',
    'exceptional_talents': 'Talents d\'exception',
    'international_recognition': 'J\'ai une reconnaissance internationale dans mon domaine',
    'no_recognition': 'Je n\'ai pas de reconnaissance internationale',
    'job_offer_question': 'Offre d\'emploi validée au Canada ?',
    'yes': 'Oui',
    'no': 'Non',
    'family_ties_question': 'Avez-vous des liens familiaux au Canada ?',
    'yes_direct_family': 'Oui (famille directe: parents, frères/sœurs, enfants)',
    'your_contact_info': 'Vos coordonnées',
    ...
    'form_consent': 'En soumettant ce formulaire, vous acceptez d\'être contacté par notre équipe pour une analyse plus approfondie de votre situation.',
    'continue': 'Continuer',
    'previous': 'Précédent',
    'submit': 'Soumettre',
    'form_reset_success': 'Le formulaire a été réinitialisé',
    'select_age_error': 'Veuillez sélectionner votre tranche d\'âge',
    'select_education_error': 'Veuillez sélectionner votre niveau d\'études',
    ...
    'select_profession_error': 'Veuillez sélectionner un type de profession',
    ...
    'select_project_error': 'Veuillez sélectionner au moins un projet au Canada',
    'fill_contact_error': 'Veuillez remplir tous les champs de contact',
    'valid_email_error': 'Veuillez entrer une adresse email valide',
    'evaluation_results': 'Résultats de votre évaluation',
    'preliminary_analysis': 'Voici une analyse préliminaire de votre admissibilité aux différents programmes d\'immigration canadiens.',
    'main_recommendation': 'Recommandation principale',
    'according_to_profile': 'Selon votre profil, le programme le plus adapté à votre situation est le',
    'next_steps': 'Prochaines étapes',
    'to_continue_process': 'Pour continuer votre processus d\'immigration, nous vous recommandons de :',
    'next_step_1': 'Consulter notre simulateur détaillé pour une évaluation plus précise',
    'next_step_2': 'Prendre rendez-vous avec un de nos consultants en immigration',
    'next_step_3': 'Préparer vos documents justificatifs (diplômes, certificats de langue, etc.)',
    'new_test': 'Faire un nouveau test',
    'book_consultant': 'Prendre rendez-vous avec un consultant',
    'no_optimal_program': 'Aucun programme optimal',
  },
  en: {
    // Navigation
    'home': 'Home',
    ...
    'age_select': 'Age (Select an age range)',
    ...
    'edu_postsecondary': 'Post-secondary Diploma (Associate\'s)',
    'edu_bachelor': 'Bachelor\'s Degree',
    'edu_master': 'Master\'s or Doctorate',
    'professional_experience': 'Professional Experience',
    'exp_none': 'No experience',
    'exp_less1': 'Less than one year',
    'exp_1_3': '1 - 3 years',
    'exp_4_5': '4 - 5 years',
    ...
    'french': 'French',
    'english': 'English',
    'french_none': 'No proficiency',
    'french_intermediate': 'Intermediate level',
    'french_fluent': 'Fluent',
    'english_none': 'No proficiency',
    'english_intermediate': 'Intermediate level',
    ...
    'project_family': 'Join a family member',
    'profession_type': 'Profession Type (QSWP)',
    'pstq_streams_description': 'The new Quebec Skilled Worker Program (QSWP) includes 4 distinct streams:',
    'prof_highly_skilled': 'Highly skilled profession (stream 1)',
    'prof_intermediate': 'Intermediate/manual profession (stream 2)',
    'prof_regulated': 'Regulated profession requiring a permit in Quebec (stream 3)',
    'prof_exceptional': 'Exceptional talent (stream 4)',
    'prof_unknown': 'I don\'t know',
    'license_permit': 'Authorization or practice permit',
    'have_license': 'I have or can obtain authorization to practice in Quebec',
    'no_license': 'I do not have authorization to practice in Quebec',
    'exceptional_talents': 'Exceptional Talents',
    'international_recognition': 'I have international recognition in my field',
    'no_recognition': 'I do not have international recognition',
    'job_offer_question': 'Validated job offer in Canada?',
    'yes': 'Yes',
    'no': 'No',
    'family_ties_question': 'Do you have family ties in Canada?',
    'yes_direct_family': 'Yes (immediate family: parents, siblings, children)',
    ...
    'form_consent': 'By submitting this form, you agree to be contacted by our team for a more in-depth analysis of your situation.',
    'continue': 'Continue',
    'previous': 'Previous',
    'submit': 'Submit',
    'form_reset_success': 'The form has been reset',
    ...
    'select_french_error': 'Please indicate your French level',
    'select_english_error': 'Please indicate your English level',
    'select_profession_error': 'Please select a profession type',
    'select_job_offer_error': 'Please indicate whether you have a job offer',
    'select_family_ties_error': 'Please indicate whether you have family ties in Canada',
    'select_project_error': 'Please select at least one project in Canada',
    'fill_contact_error': 'Please fill in all contact fields',
    'valid_email_error': 'Please enter a valid email address',
    'evaluation_results': 'Your Evaluation Results',
    'preliminary_analysis': 'Here is a preliminary analysis of your eligibility for various Canadian immigration programs.',
    'main_recommendation': 'Main Recommendation',
    'according_to_profile': 'According to your profile, the program best suited to your situation is the',
    'next_steps': 'Next Steps',
    'to_continue_process': 'To continue your immigration process, we recommend that you:',
    'next_step_1': 'Consult our detailed simulator for a more precise evaluation',
    'next_step_2': 'Make an appointment with one of our immigration consultants',
    'next_step_3': 'Prepare your supporting documents (diplomas, language certificates, etc.)',
    'new_test': 'Take a new test',
    'book_consultant': 'Book an appointment with a consultant',
    'no_optimal_program': 'No optimal program',
  }
};
