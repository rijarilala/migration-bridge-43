...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: ["Lun-Ven: 9h00 - 18h00", "Sam: 10h00 - 14h00"],
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Vous avez des questions ou besoin d'informations? N'hésitez pas à nous contacter.
              Notre équipe est prête à vous aider dans votre démarche.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1">
              <div className="bg-white shadow-sm border border-gray-100 rounded-xl p-6">
                ...
                <div className="mt-8">
                  <h3 className="font-medium text-gray-900 mb-3">Suivez-nous</h3>
